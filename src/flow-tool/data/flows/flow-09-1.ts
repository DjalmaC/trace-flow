...
export const flow091: Flow = {
  ...
  narrative:
    ...
    "sources liquidity from a Local Liquidity Provider and converts BRL to USDC/T; once abroad, " +
    "Pix Inc converts USDC/T to USD/EUR and settles to the Local Customer's Foreign Account.",
  ...
  nodes: [
    ...
    { id: "foreignacct", label: "Local Customer's Foreign Account", kind: "merchant", lane: "abroad" },
  ],
  legs: [
    ...
    { from: "pixwallet", to: "foreignacct", carries: "USDC/T", convertsTo: "USD/EUR" },
  ],
  sameActor: [
