...
// Flow 11 — Arq Argentina. A foreign payer funds in USD/USDC; value routes
// through Arqu Argentina and Pix Inc abroad, converts USD/USDC -> BRL at the
...
export const flow11: Flow = {
  id: "flow-11",
  displayId: "11",
  title: "Arq Argentina — USD/USDC funded abroad, settled in Brazil as BRL via Pix Inc NRA + Arq IP",
  blurb:
    "Argentina payout: foreign USD/USDC converts to BRL at the border and settles to a Brazilian beneficiary through Pix Inc's NRA and the Arq IP.",
  ...
  narrative:
    "A foreign payer sends USD/USDC to Arqu Argentina, which routes it through Pix Inc abroad. " +
    "At the border Pix Inc converts USD/USDC to BRL into its Brazilian Non Resident Account, then the Arq IP " +
